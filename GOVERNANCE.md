# Trickster / Mecone Governance

## Principles

The Trickster community adheres to the following principles:

- **Open**: Trickster and Mecone are Open Source Software
...
The Trickster project, including Mecone, has a project lead.
...
The Trickster organization will never forcefully remove a current Maintainer, unless they fail to meet the principles of Trickster community, or adhere to the [Code of Conduct](./CODE_OF_CONDUCT.md).
...
The [Trickster Code of Conduct](./CODE_OF_CONDUCT.md) simply points to the [CNCF Code of Conduct](https://github.com/cncf/foundation/blob/master/code-of-conduct.md).
